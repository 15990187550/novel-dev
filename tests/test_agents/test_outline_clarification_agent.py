...
def test_force_generation_intent_matches_common_phrases():
    ...
    assert OutlineClarificationAgent.is_force_generate_intent("不要再问，直接生成")
    assert OutlineClarificationAgent.is_force_generate_intent("别继续澄清，直接生成")
    assert OutlineClarificationAgent.is_force_generate_intent("不需要继续确认，按当前设定生成")
