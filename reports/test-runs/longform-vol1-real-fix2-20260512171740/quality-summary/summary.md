# Test Run longform-vol1-real-fix2-20260512171740-quality-summary
...
- Title: 世界观与设定质量详情
- Evidence: passed=True, review_batch_status=partially_approved, review_batch_summary=东方玄幻短篇测试小说全量设定生成——基于用户确认信息（青云宗、主角林照、对立势力玄火盟/血海殿、第一章目标方向）配合保守假设（炼气→筑基→金丹→元婴体系；玄火盟为表面主谋、血海殿为幕后黑手；第一章目标为藏经阁发现家族残卷并存活）
- Recommendation: none
...
- Title: 章节具体质量评价
- Evidence: chapter_id=vol_1_ch_1, quality_status=block, final_review_score=72, editor_guard_warnings_count=0, quality_gate.word_count_drift=字数严重偏离目标, quality_gate.final_review_score=成稿评分偏低: 72
- Recommendation: none
