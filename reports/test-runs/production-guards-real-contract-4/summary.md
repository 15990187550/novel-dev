# Test Run production-guards-real-contract-4
...
- `novel_id`: `codex-5126`
- `setting_session_id`: `sgs_9169217b01e9456abe87f1e3e9717051`
- `setting_session_status`: `ready_to_generate`
- `setting_clarification_round`: `1`
- `review_batch_id`: `a02a0aa4b976459c9be0a4e4b4e719f1`
- `pending_id`: `pe_46870f5f`
- `brainstorm_original_estimated_volumes`: `5`
- `brainstorm_original_estimated_total_chapters`: `260`
- `brainstorm_shrunk_estimated_total_chapters`: `1`
- `volume_id`: `vol-1`
- `chapter_id`: `acceptance-codex-5126-ch1`
- `chapter_plan_source`: `current_chapter_plan`
- `chapter_target_word_count`: `1000`
- `chapter_auto_run_job_id`: `job_bd1ec7af570e`
...
- Message: generation job polling timed out: job_bd1ec7af570e last_status=running
- Evidence: none
