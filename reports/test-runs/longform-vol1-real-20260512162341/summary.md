# Test Run longform-vol1-real-20260512162341
...
- `novel_id`: `codex-c602`
- `setting_session_id`: `sgs_46fd5b444882404aa9aeaaf2b1429120`
...
- Message: Server error '502 Bad Gateway' for url 'http://127.0.0.1:8000/api/novels/codex-c602/settings/sessions/sgs_46fd5b444882404aa9aeaaf2b1429120/reply'
