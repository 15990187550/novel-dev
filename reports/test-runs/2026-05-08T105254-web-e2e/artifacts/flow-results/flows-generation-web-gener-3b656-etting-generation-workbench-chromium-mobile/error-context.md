...
- generic [ref=e5]:
  ...
  - main:
    - generic [ref=e65]:
      - generic [ref=e66]:
        - paragraph [ref=e67]: Overview
        - heading "仪表盘" [level=2] [ref=e68]
        - paragraph [ref=e69]: 总览项目状态、风险、建议动作与实时更新。
      - generic [ref=e70]:
        - generic [ref=e71]: 未选择小说
        - generic [ref=e72]: "-"
        - button "切换暗黑模式" [ref=e73] [cursor=pointer]:
          - img [ref=e75]
    - generic [ref=e79]:
      - paragraph [ref=e80]: 请从侧边栏选择或输入一个小说 ID
      - paragraph [ref=e81]: 选中小说后，这里会展示总览、状态卡、实时日志和推荐动作。
```
